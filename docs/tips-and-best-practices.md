...
1. **First prompt:** Basic layout and sections
2. **Second prompt:** Add specific content and styling
3. **Third prompt:** Refine interactions and details
...
1. **Be specific** - Details lead to better results
2. **Structure your request** - List sections and components
3. **Include style preferences** - Colors, fonts, spacing
4. **Iterate gradually** - One change at a time
